...
1. Create `src/jobforge/demo/static/index.html`:
   ...
   - **Setup instructions panel (PREREQUISITES)**:
     - "Before starting, ensure:"
     - "1. Power BI Desktop is open with a saved .pbix file (blank or target)"
     - "2. The .pbix file has been SAVED (MCP requires a saved file to connect)"
     - "3. Claude Code is open in VS Code Pro"
...
5. Create `src/jobforge/demo/static/locales/en.json`:
   ```json
   {
     ...
     "load": {
       ...
       "button": "Load Data",
       "loading": "Loading...",
       "prerequisitesTitle": "Before starting, ensure:",
       "prerequisite1": "Power BI Desktop is open with a saved .pbix file (blank or target)",
       "prerequisite2": "The .pbix file has been SAVED (MCP requires a saved file to connect)",
       "prerequisite3": "Claude Code is open in VS Code Pro"
     },
     "powerbi": {
...
6. Create `src/jobforge/demo/static/locales/fr.json`:
   ...
   - Include French translations for prerequisites (prerequisitesTitle, prerequisite1-3) and powerbi.instructions
  </action>
  <verify>
  ...
  <how-to-verify>
    **IMPORTANT: This is a NARRATION demo - the UI shows what is being built while you trigger the actual deployment separately via Claude Code.**
    ...
    3. Verify Step 1 (Load):
       ...
       - **PREREQUISITES panel visible** with 3 items:
         - Power BI Desktop open with saved .pbix
         - File must be SAVED
         - Claude Code open in VS Code Pro
